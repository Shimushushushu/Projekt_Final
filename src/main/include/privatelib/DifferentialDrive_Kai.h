 ...
 */
class DifferentialDrive_Kai : public RobotDriveBase {
	public:
		 ...
		 */
		DifferentialDrive_Kai(SpeedController& leftMotor, SpeedController& rightMotor, SpeedController& frontMotor, SpeedController& rearMotor);
	
		~DifferentialDrive_Kai() override = default;

		DifferentialDrive_Kai(DifferentialDrive_Kai&&) = default;
		DifferentialDrive_Kai& operator=(DifferentialDrive_Kai&&) = default;
		 ...
		 */
		void ArcadeDrive_Kai(double xSpeed, double ySpeed, double zRotation, bool squareInputs = true);
